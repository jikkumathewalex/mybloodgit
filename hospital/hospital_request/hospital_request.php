...
<nav class="navbar navbar-light bg-light">
      ...
      <br>
      <form class="container form-outline" action="hospital_add_request_action.php" method="post">
           <div class="form-group"> 
               &nbsp<textarea class="form-control" rows="4" cols="50" id="txthrequest" name="txthrequest" oninput="this.reportValidity()" required="" title="Enter notification here ..." placeholder="Enter notification here ..."></textarea>
           </div>&nbsp
    ...
    <tbody>
         <?php
              ...
              while($row=mysqli_fetch_array($query))
              {
               ...
               {?> 
                <form action="hospital_cancel_action.php" method="post">
