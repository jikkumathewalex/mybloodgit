...
<?php
       ...
       $query2="select * from tbl_blood_camp where status=1";
...
<form style="margin:10px">
  ...
  <li style="margin:5px"><a href="blood_availability/blood_availability.php"><button type="button" class="btn btn-outline-danger" style="border-radius:40px;width:11rem;height:10rem">BLOOD AVAILABILITY<br><span class="w3-badge w3-red"><?php echo $row0; ?> </span></button></a>
</li>
  <li><a href="notification/notification.php"><button type="button" class="btn btn-outline-danger" style="border-radius:40px;width:10rem;height:10rem">NOTIFICATION  <br><span class="w3-badge w3-red"><?php echo $row1; ?> </span></button></a>&nbsp
...
<li style="margin:5px"><a href="hospital/hospital.php"><button type="button" class="btn btn-outline-danger" style="border-radius:40px;width:11rem;height:10rem">HOSPITAL</button></a>
<a href="feedback/feedback.php"><button type="button" class="btn btn-outline-danger" style="border-radius:40px;width:11rem;height:10rem">FEEDBACK</button></a>
<a href="blood_bank/blood_bank.php"><button type="button" class="btn btn-outline-danger" style="border-radius:40px;width:11rem;height:10rem">BLOOD BANK</button></a>
</li>
