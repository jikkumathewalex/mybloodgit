...
<?php
$querym=mysqli_query($con,"SELECT BB.*, REG.* FROM tbl_blood_bank BB, tbl_reg REG where BB.status=1 AND BB.reg_id=REG.reg_id");
$beaches = "[";
...
<nav class="navbar navbar-light bg-light">
      ...
      <form action="../feedback/admin_feedback.php"><button type="submit" class="btn btn-outline-danger" style="color:white">Blood Availability</button></form>
