...
<div style="color:#bb0a1e" class="card-header" >
      ...
      // $query="select * from tbl_reg as R, tbl_login as L, tbl_state as S, tbl_district as D, tbl_city as C, tbl_blood_bank as B, tbl_accreditation as A where R.login_id=l.login_id AND R.state_id=S.state_id AND R.district_id=D.district_id AND R.city_id=C.city_id and B.login_id='3' AND L.login_id='3'";
       $query="select * from tbl_reg R, tbl_login L, tbl_state S, tbl_district D, tbl_city C, tbl_blood_bank B, tbl_accreditation A where R.login_id='$login_id' AND L.login_id='$login_id' AND R.state_id=S.state_id AND R.district_id=D.district_id AND R.city_id=C.city_id AND B.login_id='$login_id'";
       $res=mysqli_query($con,$query);
       if (!$res) {
        printf("Error: %s\n", mysqli_error($con));
        exit();
      ...
      <form class="container" action="blood_bank_edit_profile_action.php" method="post" enctype="multipart/form-data">
...
<input type="date" class="form-control" id="acc_date" name="acc_date" onclick="ValidateDate();" required="" value="<?php echo $row['accreditation_date'] ?>">&nbsp
</div>
...
<div class="input-group mb-3">
<div class="input-group-prepend">
  <span class="input-group-text" id="basic-addon1" style="background-color:#bb0a1e;color:white;width:210px"><a style="color:white" href="../../bb_acc_certificates/<?php echo $row['accreditation_certificate'] ?>" target="_blank">Accreditation Certificate</a>&nbsp<i class="fas fa-link"></i>
</span>
</div>
<input type="file" class="form-control" name="bb_acc_certificate" id="bb_acc_certificate" accept="application/pdf" placeholder="Accreditation Certificate">
</div>

<div class="input-group mb-3">
                    
<div class="input-group-prepend">
  <span class="input-group-text" id="basic-addon1" style="background-color:#bb0a1e;color:white;width:210px">Latitude</span>
</div>
<input type="text" class="form-control" id="txtlat" name="txtlat" required="" value="<?php echo $row['bb_latitude'] ?>">&nbsp
</div>                                                    
       
<div class="input-group mb-3">
<div class="input-group-prepend">
  <span class="input-group-text" id="basic-addon1" style="background-color:#bb0a1e;color:white;width:210px">Longitude</span>
</div>
<input type="text" class="form-control" id="txtlong" name="txtlong" required="" value="<?php echo $row['bb_longitude'] ?>">&nbsp
</div>         
