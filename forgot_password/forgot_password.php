...
<div style="color:#bb0a1e" class="card-header" >
      ...
      <form  class="container" action="forgot_password_action.php" method="post">
      ...
      <div class="input-group mb-3">
          ...
          <input class="form-control" type="text" id="email" name="email" placeholder="Enter Email ID" required onchange='ValidateEmail();'>
      </div>
