...
<div style="color:#bb0a1e" class="card-header" >
      ...
      <form  class="container" action="new_password_action.php" method="post">

            <div class="card text-left">
      
      <div class="input-group mb-3">
          <div class="input-group-prepend">
              <span class="input-group-text" id="basic-addon1" style="background-color:#bb0a1e;color:white;width:220px">ENTER NEW PASSWORD</span>
          </div>
          <input class="form-control" type="password" id="new_c_pass" name="new_c_pass" placeholder="Enter New Password" required >
      </div>
