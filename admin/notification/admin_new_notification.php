...
<body>
      ...
      <br><center>
      <form class="container form-outline" action="admin_add_notification_action.php" method="post">
           
               <center><textarea class="form-control" rows="4" cols="50" id="txtNotification" name="txtNotification" oninput="this.reportValidity()" required="" title="Enter New Notification" placeholder="Enter new notification here ..."></textarea></center>
           <br>
    ...
    <tbody>
         <?php
              $query=mysqli_query($con,"SELECT * FROM tbl_notification WHERE status=1 ORDER BY date,time DESC");
              ...
              while($row=mysqli_fetch_array($query))
              {
               ...
               {?>
                <form action="admin_notification_action.php" method="post">
