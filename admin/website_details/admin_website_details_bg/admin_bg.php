...
<body>
    ...
    <div style="color:#bb0a1e" class="card-header" >
        <center><h2>BLOOD GROUP</h2></center>
    </div>
<br>

      <form class="container" action="admin_add_bg_action.php" method="post">
      <center>     
      ...
      <div class="input-group mb-3">
          <div class="input-group-prepend">
              <span class="input-group-text" id="basic-addon1" style="background-color:#bb0a1e;color:white;width:220px">Blood Group</span>
               ...
               <input type="text" class="form-control" id="txtBG" name="txtBG" oninput="this.reportValidity()" required="" aria-describedby="emailHelp" title="Enter Blood Group" placeholder="Enter Blood Group">&nbsp
           </div>
...
<br><br><br>
<center>
<i class="fas fa-search"></i>&nbsp<input type="text" id="sBG" onKeyUp="searchBG()" placeholder="Enter Blood Group">&nbsp;
</center>
<script>
function searchBG() {
...
<br>
  ...
  <tbody>
     <?php
          $query=mysqli_query($con,"SELECT * FROM tbl_blood_group where status=1 ORDER BY blood_group ASC");
          while($row=mysqli_fetch_array($query))
          {
           ...
           $query1=mysqli_query($con,'SELECT * FROM  tbl_blood_group where blood_group_id="'.$row['blood_group_id'].'" AND status=1');
           if(mysqli_num_rows($query1))
           {?>
            <form action="admin_bg_action.php" method="post">
              <input type="hidden" name="delete" id="delete" value="<?php echo $row['blood_group_id'] ?>">
