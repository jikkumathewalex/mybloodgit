...
<form style="margin:10px">
  <ul class="mylist">
  <li style="margin:5px"><a href="admin_website_details_info/admin_info.php"><button type="button" class="btn btn-outline-danger" style="border-radius:40px;width:10rem;height:10rem">WEBSITE INFO</button></a>
</li>
  <li><a href="admin_website_details_location/admin_location.php"><button type="button" class="btn btn-outline-danger" style="border-radius:40px;width:10rem;height:10rem">LOCATION</button></a>&nbsp
  <a href="admin_website_details_bg/admin_bg.php"><button type="button" class="btn btn-outline-danger" style="border-radius:40px;width:10rem;height:10rem">BLOOD GROUP</button></a></li>
